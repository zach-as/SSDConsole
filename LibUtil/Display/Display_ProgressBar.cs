...
namespace LibUtil.UtilDisplay
{
    public static partial class CDisplay
    {
        ...
        public static void StartProgressBar(string message, int? max_progress, params ProgressBarInfo[] info)
        {
            if (InProgress())
            {
        ...
        public static void StartProgressBar(string message, params ProgressBarInfo[] info)
        ...
        public static void UpdateProgressBar(int amount, string? id = null)
        {
            if (currentProgressBar is null)
            {
        ...
        public static void UpdateProgressBar(string? id)
