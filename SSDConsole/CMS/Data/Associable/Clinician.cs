...
{
    internal class Clinician : Associable
    {
        ...
        public Clinician(RecordItem record)
        {
            ...
            this.sex = record.Sex; // This should always == "M" or "F" according to the schema
        ...
        internal OptionSetValue Sex()
        {
            // code for male = 924040000, code for female = 924040001
            // return sex.Contains("M") ? 924040000 : 924040001;
