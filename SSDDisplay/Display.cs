...
namespace SSDConsole.SSDDisplay
{
    ...
    internal static partial class Display
    {
        ...
        internal static async Task BeginDisplay()
        {
        ...
        internal static void Interrupt(string message, MessageSeverity severity)
            => interruptMessages.Add(new Message(message, MessageSource.Interrupt, severity));
        internal static void Interrupt(string message)
